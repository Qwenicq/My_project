========================================================================
       CLUSTER RESOURCE DLL : Ê÷ (Ê÷)
========================================================================


AppWizard has created this Ê÷ resource DLL for you.  This
...
that make up your Ê÷ resource DLL.
...
To add your resource type to the cluster, use cluster.exe.
    ...
    cluster resourcetype "Ê÷" /create /dllname:Ê÷.dll
...
You can now create resources of type "Ê÷" using either
...
use a command like the following:
    ...
    cluster resource "My Ê÷" /create /group:"My Group" /type:"Ê÷"
    cluster resource "My Ê÷" /privproperties
