...
#include "ExtObjID.h"	// for CLSID_CoMyEx
#endif
...
class CExtObject :
	...
	public CComCoClass<CExtObject, &CLSID_CoMyEx>
{
public:
	CExtObject(void);
...
DECLARE_REGISTRY(CExtObject, _T("CLUADMEX.MyEx"), _T("CLUADMEX.MyEx"), IDS_CLUADMEX_COMOBJ_DESC, THREADFLAGS_APARTMENT)
