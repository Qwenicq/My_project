========================================================================
       CLUSTER ADMINISTRATOR EXTENSION : Ê÷
========================================================================
...
Ê÷Ex.cpp
    This is the main DLL source file.  It contains the class CMyApp.
...
StdAfx.h, StdAfx.cpp
    ...
    named Ê÷.pch and a precompiled types file named StdAfx.obj.
...
ResProp.h
    ...
    written.  It defines the CÊ÷ParamsPage class.

ResProp.cpp
    This is the source file which implements the CÊ÷ParamsPage class.
...
(typically C:\MSDEV\BIN):
    ...
    RegClAdm [/cclustername] Ê÷Ex.dll
